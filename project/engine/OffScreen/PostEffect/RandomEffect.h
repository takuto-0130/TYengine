...
namespace TYEngine
{
	namespace OffScreen
	{
		...
		public:
			...
			void SetNoiseTint(const Utility::Vector3& c) { param_->noiseTint = c; }
			...
			Utility::Vector3 GetNoiseTint() const { return param_->noiseTint; }
		...
		private:
			...
			struct RandomParam
			{
				...
				Utility::Vector3 noiseTint = { 0.3f, 0.3f, 0.3f }; ///< ノイズの色味（RGB）
			};
