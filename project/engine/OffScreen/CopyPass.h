...
namespace TYEngine
{
	namespace OffScreen
	{
		...
		{
			Utility::Vector2 offset; ///< UV オフセット。
			Utility::Vector2 scale;  ///< UV スケール。
		};
		...
		public:
			...
			void Initialize(Core::DirectXBasis* dxBasis, Graphics::SrvManager* srvMgr, const std::wstring& vsPath, const std::wstring& psPath);
		...
		private:
			...
			Graphics::SrvManager* srvMgr_ = nullptr;
