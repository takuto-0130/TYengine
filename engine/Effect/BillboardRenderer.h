...
public:
    BillboardRenderer(Camera* camera, SrvManager* srvMgr);
    void Initialize();
    ...
    void SetTextureIndex(int index) { srvIndex_ = index; }

private:
    static const int kMaxInstance = 1000;
    Camera* camera_;
    SrvManager* srvMgr_;
    int srvIndex_ = -1;
