...
namespace TYEngine
{
	namespace OffScreen
	{
		...
		public:
			...
			void SetCenter(const Utility::Vector2& c) { param_->kCenter = c; }
			...
			Utility::Vector2 GetCenter() const { return param_->kCenter; }
		...
		private:
			...
			{
				Utility::Vector2 kCenter = { 0.5f, 0.5f }; ///< ブラーの中心（0.5,0.5 は画面中央）
